...
import { getFilesData, viewFolder } from '@store/history/data';
...
export const History: React.FC = () => {
  ...
  const { historyData, view, status } = useAppSelector(getFilesData);

  const onChangeFolderViewed = (view: FolderView) => {
    storageService.setItem('viewFolderHistory', view);
