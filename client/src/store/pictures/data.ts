...
const folderVariant: FolderView = storageService.getItem('viewFolderPictures') ?? 'list';
...
const PicturesDataSlice = createSlice({
  name: 'PicturesDataSlice',
  initialState,
  reducers: {
...
const selectSelf = (state: RootState) => state.pictures.data;
...
export const { selectedDir, saveSearchText, clearBeadcrumbsStack, dropState, viewFolder } =
  PicturesDataSlice.actions;

export { getFilesData };
export default PicturesDataSlice.reducer;
